...
var getGame = function(connection, idGame){
    return new Promise(function(resolve, reject) {
        request(connection,
            ...
            + " Select e.name as eventName, e.city as eventCity, white.name as whiteName, black.name as blackName, g.whiteElo, g.blackElo, g.date, g.result, o.opening, o.variation, o.nbMoves"
    ...
    var getPartialGame = function(connection, idGame){
        return new Promise(function(resolve, reject) {
            request(connection,
                ...
                // get meta-data of a game
                + " Select e.name as eventName, e.city as eventCity, white.name as whiteName, black.name as blackName, g.date, g.result"
